...
public class ApiReference {
    ...
    public static final String SINGLE_JOKE_URL = ICNDB_BASE_URL + "/jokes/";
    ...
    public static final String ALL_JOKES_COUNT_URL = ICNDB_BASE_URL + "/jokes/count";

    // Joke categories url
    // http://api.icndb.com/categories
    // returns a list of the categories of jokes as a json
    public static final String JOKE_CATEGORIES_URL = ICNDB_BASE_URL + "/categories";
}
